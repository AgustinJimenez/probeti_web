<script type="text/javascript">
	...
	function refrescar()
	{
		...
		console.log("cliente_id="+selected_cliente_id+" obra_id="+selected_obra_id);
	...
	{
		var cliente_selected_id = $("#clientes option:selected").val();
		if(cliente_selected_id == '')
			cliente_selected_id = 0;
		else
			cliente_selected_id = parseInt(cliente_selected_id);
	...
	function calcular_totales()
	{
		...
		var cantidad_facturadas = get_cantidad('.todas-facturadas'); 
		var cantidad_cobrar = get_cantidad('.todas-por_cobrar'); 
		...
		chicas = get_cantidad2(".chicas:visible .facturadas");
		medianas = get_cantidad2(".medianas:visible .facturadas");
		grandes = get_cantidad2(".grandes:visible .facturadas");
		...
		chicas = get_cantidad2(".chicas:visible .por_cobrar");
		medianas = get_cantidad2(".medianas:visible .por_cobrar");
		grandes = get_cantidad2(".grandes:visible .por_cobrar");
	...
	function mostrar_remision(remision)
	{
		...
		facturadas = parseInt(medianas.find(".facturadas").text());
