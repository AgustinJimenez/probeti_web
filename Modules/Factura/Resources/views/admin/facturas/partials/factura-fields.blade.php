...
<fieldset>
    ...
    @if($factura->id)
        {!! Form::$DEBUG('cabecera[id]', $factura->id , ['style' => 'width:30px; margin-top:-65px !important; background-color:LawnGreen ;', "readonly" => "readonly", "class" => "id"]) !!}
    @endif
    <div class="box-body cabecera">
        <div class="row">
            <div class="form-group col-md-6 {!! $errors->first('cabecera[razon_social]',  'has-error') !!} {!! $errors->first('cabecera[cliente_id]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[razon_social]', old('cabecera[razon_social]',$factura->razon_social) , array('class' => 'form-control input-md razon_social ', 'placeholder' => "Razon Social", 'id' => 'razon_social', 'required' => 'required')) !!}
                <p class="success" id="cliente_seleccionado"></p>
                {!! Form::$DEBUG('cabecera[cliente_id]', old('cabecera[cliente_id]',$factura->cliente_id) , ['style' => 'width:30px; margin-top:-65px; background-color:DeepSkyBlue ;!important;', "readonly" => "readonly", "class" => "cliente_id"]) !!}
            ...
            <div class="form-group col-md-6 {!! $errors->first('cabecera[direccion]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[direccion]', old('cabecera[direccion]',$factura->direccion), array('class' => 'form-control input-md direccion ', 'placeholder' => "Direccion" , 'id' => 'direccion', 'required' => 'required')) !!}
        ...
        <div class="row">
            <div class="form-group col-md-2 {!! $errors->first('cabecera[ruc]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[ruc]', old('cabecera[ruc]',$factura->ruc) , array('class' => 'form-control input-md ruc ', 'placeholder' => "RUC" , 'id' => 'ruc', 'required' => 'required')) !!}
            ...
            <div class="form-group col-md-2 {!! $errors->first('cabecera[telefono]',  'has-error') !!}">
                ...
                {!! Form::number('cabecera[telefono]', old('cabecera[telefono]',$factura->telefono) , array('class' => 'form-control input-md telefono ', 'placeholder' => "Telefono" , 'id' => 'telefono', 'min' => '0')) !!}
            ...
            <div class="form-group col-md-2 {!! $errors->first('cabecera[forma_de_pago]',  'has-error') !!}">
                ...
                {!! Form::select('cabecera[forma_de_pago]', ['contado' => 'Contado', 'credito' => 'Credito'], old('cabecera[forma_de_pago]',$factura->forma_de_pago), ['class' => 'form-control input-md forma_pago', 'id' => 'forma_pago']) !!}
            ...
            <div class="form-group col-md-3 {!! $errors->first('cabecera[fecha]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[fecha]', old('cabecera[fecha]',$factura->fecha), array('class' => 'form-control input-md fecha ', 'placeholder' => "Fecha" , 'id' => 'fecha', 'required' => 'required')) !!}
            ...
            <div class="form-group col-md-3 {!! $errors->first('cabecera[nro_factura]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[nro_factura]', old('cabecera[nro_factura]',$factura->nro_factura), array('class' => 'form-control input-md nro_factura white-input', 'placeholder' => "Nro. de Factura" , 'id' => 'nro_factura', 'readonly' => 'readonly')) !!}
...
<!--==========================DETALLES================================================-->
            @include('factura::admin.facturas.partials.factura-detalles')
<!--==========================DETALLES================================================-->
        </div>
    </div>
    <?php $margin_right = 1;?>
    <div id="box-body footer">
        <div class="row">
            ...
            <div class="col-md-9 {!! $errors->first('cabecera[monto_total_letras]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[monto_total_letras]', old('cabecera[monto_total_letras]',$factura->monto_total_letras), array('class' => 'form-control input-md monto_total_letras white-input2', 'id' => 'monto_total_letras', 'readonly' => 'readonly', "tabIndex" => "-1")) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-3 {!! $errors->first('cabecera[iva_5_total]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[iva_5_total]', old('cabecera[iva_5_total]',$factura->iva_5_total), array('class' => 'form-control input-md iva_5_total white-input2', 'id' => 'iva_5_total', 'readonly' => 'readonly', "tabIndex" => "-1")) !!}
            ...
            <div class="col-md-3 {!! $errors->first('cabecera[iva_10_total]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[iva_10_total]', old('cabecera[iva_10_total]',$factura->iva_10_total), array('class' => 'form-control input-md iva_10_total white-input2', 'id' => 'iva_10_total', 'readonly' => 'readonly', "tabIndex" => "-1")) !!}
            ...
            <div class="col-md-3 {!! $errors->first('cabecera[iva_total]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[iva_total]', old('cabecera[iva_total]',$factura->iva_total), array('class' => 'form-control input-md iva_total white-input2', 'id' => 'iva_total', 'readonly' => 'readonly', "tabIndex" => "-1")) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-9 {!! $errors->first('cabecera[observacion]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[observacion]', old('cabecera[observacion]',$factura->observacion), array('class' => 'form-control input-md observacion',  "placeholder" => "Observacion",'id' => 'observacion')) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-9 {!! $errors->first('cabecera[detalle_pago]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera[detalle_pago]', old('cabecera[detalle_pago]',$factura->detalle_pago), array('class' => 'form-control input-md detalle_pago', "placeholder" => "Detalle de pago", 'id' => 'detalle_pago')) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-9 {!! $errors->first('cabecera[orden_compra]',  'has-error') !!}">
                ...
                {!! Form::text('cabecera['.$name.']', old('cabecera[orden_compra]',$factura->orden_compra), array('class' => 'form-control input-md '.$name, "placeholder" => $title, 'id' => $name)) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                {!! Form::normalCheckbox('cabecera[anulado]', 'Anulado', $errors, (object)["cabecera[anulado]" => old('cabecera[anulado]',$factura->anulado)]) !!}
            </div>
            <div class="col-md-2">
